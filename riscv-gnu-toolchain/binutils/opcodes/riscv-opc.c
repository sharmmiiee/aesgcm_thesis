...
/* customize carry-less multiplication for GCM (added by sharmine) */
{"mulcl",        0, INSN_CLASS_ZMMUL, "d,s,t",     MATCH_MULCL, MASK_MULCL, match_opcode, 0 },
{"mulclh",       0, INSN_CLASS_ZMMUL, "d,s,t",     MATCH_MULCLH, MASK_MULCLH, match_opcode, 0 },

/* customize carry-less multiplication immediate for GCM (added by sharmine) */
{"mulcli",       0, INSN_CLASS_I, "d,s,j",     MATCH_MULCLI, MASK_MULCLI, match_opcode, 0 },
{"mulclhi",      0, INSN_CLASS_I, "d,s,j",     MATCH_MULCLHI, MASK_MULCLHI, match_opcode, 0 },
