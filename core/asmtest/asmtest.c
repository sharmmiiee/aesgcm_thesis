...
//
//        //printf("\n\nTEST C *************************************************\n");
//	//mulclimm_ex3(); // operand A = all ones
...
// nop inbetween load and mul immediate
void mulclimm_ex1(void) {
    int32_t mulclimm_result, mulclhimm_result;
...
//    int32_t mulclimm_result, mulclhimm_result;
//    //int32_t operand1 = 0xFFFFFFFF;
//    int32_t operand1 = 0x00007000;
//
//    asm volatile (
//        ".text\n"
//	"nop\n"
//        "    mulclhi %[mulclhimm_result], %[operand1], %[imm_value]\n"
//	"nop\n"
//        "    mulcli %[mulclimm_result], %[operand1], %[imm_value]\n"
//	"nop\n"
//        : [mulclhimm_result] "=r" (mulclhimm_result), [mulclimm_result] "=r" (mulclimm_result),
//          [operand1] "=&r" (operand1)  // Use early-clobber to prevent input/output conflict
//	: [imm_value] "i" (0x87)  // Input operands
//    );
//
//    printf("\n=== MULCLI and MULCLHI (Immediate) ===\n");
...
//// working but not the test case that I needed
//void mulclimm_ex5(void) {
//    int32_t mulclimm_result, mulclhimm_result;
//    int32_t operand1_print,operand2_print;
//
...
//    // Print the results
//    printf("mulclhi: actual = %lxh \t expected = 0h \n", (unsigned long)mulclhimm_result);
//    printf("mulcli : actual = %lxh \t expected = 87000dh \n", (unsigned long)mulclimm_result);
//}


//// not working and not the test case that I needed
//void mulclimm_ex5(void) {
//    int32_t mulclimm_result, mulclhimm_result;
//    int32_t operand1_print = 0x00001000;
//
//    asm volatile (
//        ".text\n"
//        //"    lui %[reg_operand1], 0x00001\n"                // Load upper immediate for operand1
...
//
//
//void mulcl_ex8(void) { // mulcl_ex5 with clock count
//    int32_t mulcl_result, mulclh_result;
//    int32_t operand1_print,operand2_print;
//
//    unsigned int pcmr = 1; /* global enable without saturation */
...
//    asm volatile (
//        ".text\n"
//        "    lui %[reg_operand1], 0xAAAAA\n"                // Load upper immediate for operand1
//        "    ori %[reg_operand1], %[reg_operand1], -2730\n" // Load lower immediate for operand1
//        "    lui %[reg_operand2], 0xFFFFF\n"                // Load upper immediate for operand2
//        "    ori %[reg_operand2], %[reg_operand2], -4095\n" // Load lower immediate for operand2
//        "    csrr %0, 0x780 \n" // Clock cycle counter start for MULCLH
//        "    mulclh %[mulclh_result], %[reg_operand1], %[reg_operand2]\n"
//        "    csrr %1, 0x780 \n" // Clock Counter End for MULCLH
//        "    csrr %2, 0x780 \n" // Clock cycle counter start for MULCL
...
//void mulclimm_ex1(void) {
//    int32_t mulcli_result, mulclhi_result;
//    int32_t operand1_print;
//
//    asm volatile (
//        ".text\n"    
...
//        "    ori %[reg_operand1], %[reg_operand1], 0x167\n" // Load lower immediate for operand1
//	"    nop\n"
//        "    mulclhi %[mulclhi_result], %[reg_operand1], %[imm_value]\n"
//        "    mulcli %[mulcli_result], %[reg_operand1], %[imm_value]\n"
//        : [mulclhi_result] "=r" (mulclhi_result), [mulcli_result] "=r" (mulcli_result),
//          [reg_operand1] "=&r" (operand1_print) // input operand
//	: [imm_value] "i" (0x87)  // Input operands
//    );
//
//    printf("\n=== MULCLI and MULCLHI example 3 ===\n");
//
//    // Print the loaded values for debugging purposes
//    printf("Operand1: %lxh\n", (unsigned long)operand1_print);
//    printf("Operand2: 87h\n");
//    // Print the results
//    printf("mulclhi: actual = %lxh \t expected = 2dh \n", (unsigned long)mulclhi_result);
//    printf("mulcli : actual = %lxh \t expected = e8cb55b5h \n", (unsigned long)mulcli_result);
//}
//
//void mulclimm_ex2(void) { // mulclimm_ex1 with clock count
//    int32_t mulcli_result, mulclhi_result;
//    int32_t operand1_print;
//
//    unsigned int pcmr = 1; /* global enable without saturation */
...
//        "    csrr %3, 0x780 \n" // Clock Counter End for MULCL
//        "    nop\n"
//        : "=r" (start_cc_h), "=r" (end_cc_h), "=r" (start_cc_l), "=r" (end_cc_l), [mulclhi_result] "=r" (mulclhi_result), [mulcli_result] "=r" (mulcli_result),
//          [reg_operand1] "=&r" (operand1_print)  // Input operands
//	: [imm_value] "i" (0x87)  // Input operands
//    );
//
...
//    asm volatile ("csrw 0x7e0, %0" :: "r" (0));
//
//    printf("\n=== MULCLI and MULCLHI example 3 (with clock cycle counts) ===\n");
//
//    // Print the loaded values for debugging purposes
//    printf("Operand1: %lxh\n", (unsigned long)operand1_print);
//    printf("Operand2: 87h\n");
...
//
//
//void mulclimm_ex3(void) { // operand A = all ones
//    int32_t mulcli_result, mulclhi_result;
//    int32_t operand1_print;
//
//    unsigned int pcmr = 1; /* global enable without saturation */
...
//    asm volatile (
//        ".text\n"
//	"    lui %[reg_operand1], 0xFFFFF\n"                // Load upper immediate for operand1
//        "    ori %[reg_operand1], %[reg_operand1], 0x7FF\n" // Load lower immediate for operand1
//        "    csrr %0, 0x780 \n" // Clock cycle counter start for MULCLH
//        "    mulclhi %[mulclhi_result], %[reg_operand1], %[imm_value]\n"
//        "    csrr %1, 0x780 \n" // Clock Counter End for MULCLH
//        "    csrr %2, 0x780 \n" // Clock cycle counter start for MULCL
...
//    asm volatile ("csrw 0x7e0, %0" :: "r" (0));
//
//    printf("\n=== MULCLI and MULCLHI example 4 (operand = all ones) ===\n");
//
//    // Print the loaded values for debugging purposes
//    printf("Operand1: %lxh\n", (unsigned long)operand1_print);
//    printf("Operand2: 87h\n");
...
//    printf(" total clock cycle (MULCLHI) = %u\n", end_cc_h - start_cc_h);
//
//    printf("mulcli : actual = %lxh \t expected = 0000007dh \n", (unsigned long)mulcli_result);
//    printf(" start clock cycle (MULCLI) = %u\n", start_cc_l);
//    printf(" end clock cycle (MULCLI) = %u\n", end_cc_l);
//    printf(" total clock cycle (MULCLI) = %u\n\n", end_cc_l - start_cc_l);
//}
...
//    int32_t operand1_print;
//    asm volatile (
//        //"    ori %[reg_operand1], %[reg_operand1], -1 \n" // Load lower immediate for operand1
//        "    ori %[reg_operand1], %[reg_operand1], 0xA00 \n" // Load lower immediate for operand1
//        :  [reg_operand1] "=&r" (operand1_print)  // Input operands
//	);
//    printf("Operand1: %lxh\n", (unsigned long)operand1_print);
//}
...
void ori(void) {
    ...
    asm volatile (
        //"    ori %[reg_operand1], %[reg_operand1], -0xA00 \n"
        //"    ori %[reg_operand1], %[reg_operand1], -0x0FFF \n"
        "    ori %[reg_operand1], %[reg_operand1], 0x0FF \n"
        : [reg_operand1] "=&r" (operand1_print) // Output operand
        : "r" (operand1_print)       // Input operand
    );
    printf("Operand1: %lxh\n", (unsigned long)operand1_print);
}
