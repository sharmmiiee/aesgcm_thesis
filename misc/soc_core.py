...
def soc_core_args(parser):
    ...
    soc_group.add_argument("--cpu-type",          default="cv32e40p",               help="Select CPU: {}.".format(", ".join(iter(cpu.CPUS.keys()))))
    ...
    #soc_group.add_argument("--integrated-main-ram-size", default=0x8000, type=auto_int, help="size/enable the integrated main RAM.")
    soc_group.add_argument("--integrated-main-ram-size", default=0x9000, type=auto_int, help="size/enable the integrated main RAM.")
