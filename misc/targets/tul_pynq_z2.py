...
def main():
    ...
    #parser.add_target_argument("--sys-clk-freq", default=70e6, type=float, help="System clock frequency.")
    #50MHz no timing error
    parser.add_target_argument("--sys-clk-freq", default=50e6, type=float, help="System clock frequency.")
    #parser.add_target_argument("--sys-clk-freq", default=55e6, type=float, help="System clock frequency.")
